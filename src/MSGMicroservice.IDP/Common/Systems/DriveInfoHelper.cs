    ...
    public static void CheckDriveInfo()
    {
        ...
        foreach (DriveInfo d in allDrives)
        {
            ...
            if (d.IsReady == true)
            {
                ...
                Console.WriteLine("  Available space to current user:{0, 15} GB", d.AvailableFreeSpace/1024/1024);
        ...
        {
            Console.WriteLine("Drive: {0} TotalSpace:{1} FreeSpace:{2}",item.Name,item.TotalSize/1024/1024 ,item.AvailableFreeSpace/1024/1024);
