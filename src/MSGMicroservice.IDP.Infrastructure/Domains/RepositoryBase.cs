...
namespace MSGMicroservice.IDP.Infrastructure.Domains
{
        ...
        where T : EntityBase<K>
    {
        ...
        public RepositoryBase(MsgIdentityContext dbContext, IUnitOfWork unitOfWork)
        {
        ...
        public async Task<TModel> QueryFirstOrDefaultAsync<TModel>(string sql, object? param,
            ...
            int? commandTimeout = 30) where TModel : EntityBase<K>
        {
            var entity = await _dbContext.Connection.QueryFirstOrDefaultAsync<TModel>(sql, param, transaction,
        ...
        public async Task<TModel> QuerySingleAsync<TModel>(string sql, object? param,
            ...
            int? commandTimeout = 30) where TModel : EntityBase<K>
        {
            return await _dbContext.Connection.QuerySingleAsync<TModel>(sql, param,
